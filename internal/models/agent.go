...
type Agent struct {
	...
	Type         string    `gorm:"column:agent_type;type:text;default:simple" json:"type"`
	Tools        string    `gorm:"type:text" json:"tools"`
	Skills       string    `gorm:"type:text" json:"skills"`
	Mcp          string    `gorm:"type:text" json:"mcp"`
	MaxIterations int      `gorm:"column:max_iterations;type:integer;default:100" json:"max_iterations"`
