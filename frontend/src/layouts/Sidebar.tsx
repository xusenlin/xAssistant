...
import { MessageSquare, Clock, FolderOpen, Sparkles, Wrench, Cable, Settings, Scale, LayoutDashboard } from "lucide-react";
...
const navItems = [
  ...
  { path: "/settings/models", label: "Models", icon: Scale },
];
