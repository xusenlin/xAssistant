export default function Logo({className}: {className?: string}) {
    return (
        <svg className={`w-6 ${className || ""}`} viewBox="0 0 118.5926 99.2841">
            <path className="fill-foreground"
                  ...
                  transform="translate(-1.1793 -0.9687)"></path>
            <rect className="fill-foreground" x="103.7963" y="60.5296" width="14.7963" height="24.7034" rx="2"></rect>
            <rect className="fill-foreground" y="60.5296" width="14.7963" height="24.7034" rx="2"></rect>
            <path className="fill-foreground"
            ...
            <path className="fill-foreground"
                  ...
                  transform="translate(-1.1793 -0.9687)"></path>
            <circle className="eye fill-background xAssistant-icon-running" cx="43.1636" cy="25.1695" r="6.1975"></circle>
            <circle className="eye fill-background xAssistant-icon-running" cx="75.3906" cy="25.1695" r="6.1975"></circle>
        </svg>
    );
}